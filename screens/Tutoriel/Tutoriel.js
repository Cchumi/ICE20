        ...
        <View style={[styles.slide, { backgroundColor: 'rgba(226, 0, 122, 1)' }]}>
         ...
         <View style={styles.topContainer}>
          ...
          <View style={styles.middleContainer}>
            ...
            <Text style={styles.textConditions} onPress={() => this.props.navigation.navigate("ConditionsGeneralesTuto")} >Conditions Générales</Text>
          </View>
        </View>
      </Swiper>
      </View>
...
export default withNavigation(Tutoriel);