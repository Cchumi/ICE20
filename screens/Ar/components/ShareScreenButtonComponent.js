...
class ShareScreenButtonComponent extends Component {
  ...
  render() {
    ...
    return (
      ...
      <View>
          <Icon name={this.props.buttonState === 'on' ? this.props.stateImageArray[0] : this.props.stateImageArray[1]} size={this.props.sizeIcon} color={this.props.colorIcon} type={this.props.type} />
      {/*<Image source={require("../js/res/controls/stop.png")}/>
        <Animated.Image 
